@echo off
cls
title C0m0dBIOS - system (Windows 1 Bat Edition)
color 1f
echo (c) Gioye Productions 2021-2023 all rights reversed.
echo (c) BatOS 2023 all rights reversed.
echo (c) Prydev 2023 all righs reversed
echo (c) Gioye's Creations 2014-2023 all righs reversed.
echo 888       888 d8b               888                                       d888   
echo 888   o   888 Y8P               888                                      d8888   
echo 888  d8b  888                   888                                        888   
echo 888 d888b 888 888 88888b.   .d88888  .d88b.  888  888  888 .d8888b         888 [THANKS PRYDEV]  
echo 888d88888b888 888 888 "88b d88" 888 d88""88b 888  888  888 88K             888 [THANKS PRYDEV]  
...
echo green - reboots windows 1 into a nice, peaceful green version.
...
echo restart - restarts the PC running the BAT file.
echo batshutdown - shutdowns the PC running the BAT file.
echo flash -!- WARNING: DO NOT RUN THIS COMMAND IF YOU'RE SENSIBLE TO FLASHING LIGHTS. runs a beta app that flashes forever.
echo batver - says the version of the PC running the BAT file.
echo Utility - spams utility apps.
echo THANK YOU PRYDEV! 
echo (-)-(-)
cmd 
